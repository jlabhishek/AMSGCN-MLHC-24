...
for alpha in alpha_all:
    ...
    for i in range(len(label[0])):
        ...
        # r=r11+alpha*r12
        # unnorm_logits = [wt*(val+val2) for wt,val,val2 in zip(alpha,rs,rgg)]
        # import pdb;pdb.set_trace()
        norm_logits =   [softmax(wt*(val+val2)) for wt,val,val2  in zip(alpha,rs,rgg)]
    ...
    print(norm_acc,loss_norm,alpha)
    # import pdb;pdb.set_trace()


# print("acc unnorm",max_acc,max_acc_wt)
# print("acc norm",max_nacc,max_nacc_wt) 

# print("loss unnom",min_loss,min_loss_wt)
# print("loss norm",min_nloss,min_nloss_wt) 

# print(  min_loss_wt ,",",  min_nloss_wt)
alpha_new=[]
